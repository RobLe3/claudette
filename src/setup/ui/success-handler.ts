...
export class SuccessHandler {
  ...
  private displaySupportInfo(): void {
    ...
    console.log(`   • Documentation: ${chalk.underline('https://claudette.dev/docs')}`);
    console.log(`   • GitHub Discussions: ${chalk.underline('https://github.com/claudette/discussions')}`);
